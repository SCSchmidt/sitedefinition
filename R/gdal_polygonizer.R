...
## Function to convert raster to polygone
##by John Baumgartner https://johnbaumgartner.wordpress.com/2012/07/26/getting-rasters-into-shape-from-r/

## neu nach github: https://gist.github.com/Pakillo/c6b076eceb0ef5a70e3b
...
polygonizer <- function(x, outshape=NULL, gdalformat = 'ESRI Shapefile',
  ...
  #system2('python',
  system2('C:\\Program Files\\QGIS Essen\\OSGeo4W.bat',
